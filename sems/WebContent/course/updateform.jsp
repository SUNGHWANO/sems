...
번호: <input type='text' name='no' 
            value='<%=course.getNo()%>' readonly><br>
과정명: <input type='text' name='title' 
            value='<%=course.getTitle()%>'><br>
설명: <textarea name='description' 
          rows='10' cols='80'><%=course.getDescription()%></textarea><br>
교육시간: <input type='text' name='hours' 
            value='<%=course.getHours()%>'><br>
